...
/// Full, filterable list of posted sales invoices — backed by the same
/// `GET /admin/sales-invoices` listing `PosService.fetchSalesList` already
/// wraps for the Reports "More" tab preview, but unlimited and with its own
...
class _SalesReportScreenState extends State<SalesReportScreen> {
  ...
  Future<void> _load() async {
    ...
    try {
      ...
      final items = await service.fetchSalesList(
  ...
  Widget build(BuildContext context) {
    ...
    final totalSales = _items.fold<double>(0, (sum, i) => sum + i.total);

    return Scaffold(
      appBar: AppBar(title: Text(l10n.salesReportScreenTitle)),
      body: SafeArea(
        child: Column(
          children: [
            Container(
                ...
                children: [
                  TextField(
                    decoration: InputDecoration(
                      ...
                      hintText: l10n.salesReportScreenSearchHint,
                    ),
                    onSubmitted: (value) {
                      ...
                      if (_isLoading)
                        ...
                        Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              Text(l10n.salesReportScreenTotalLabel(_items.length), style: AppTextStyles.label),
                              Text('NPR ${totalSales.toStringAsFixed(0)}', style: const TextStyle(fontSize: 16, fontWeight: FontWeight.w700, color: AppColors.success)),
                            ],
                          ),
                        ),
                        ...
                        RecentTransactionsList(
                          ...
                          emptyMessage: l10n.salesReportScreenEmptyMessage,
                          limit: null,
                        ),
                      ],
                    ],
