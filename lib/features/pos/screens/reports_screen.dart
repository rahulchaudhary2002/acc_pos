    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: AppSpacing.item),
          _kv(grossLabel, 'NPR ${gross.toStringAsFixed(2)}'),
          const SizedBox(height: 6),
          _kv(returnsCount > 0 ? '$returnsLabel ($returnsCount)' : returnsLabel, '− NPR ${returns.toStringAsFixed(2)}', valueColor: AppColors.dangerDark),
          const Padding(
            padding: EdgeInsets.symmetric(vertical: AppSpacing.field),
            child: Divider(height: 1, color: AppColors.surfaceTotals),
          ),
          _kv(netLabel, 'NPR ${net.toStringAsFixed(2)}', bold: true, valueColor: netColor),
          const SizedBox(height: 6),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text('NPR ${metric.value.toStringAsFixed(0)}', style: const TextStyle(fontSize: 20, fontWeight: FontWeight.w700)),
