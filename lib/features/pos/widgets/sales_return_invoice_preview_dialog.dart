...
/// Post-sales-return receipt — same "TAX INVOICE"-style layout as
/// [showInvoicePreview] (see invoice_preview_dialog.dart), titled
/// "SALES RETURN" and without payment-mode/delivery fields, since a return
/// doesn't carry those.
Future<void> showSalesReturnInvoicePreview(
  ...
  final metaRows = [
    [('Return No', result.documentNo), ('Return Date', _formatDate(now))],
    [('Counter No.', counterNo), null],
    [('Customer Name', customerName ?? 'Walk-in Customer'), null],
